...
class _SecretAgentHomeState extends State<SecretAgentHome> {
  ...
  final List<moollama_agent.Message> _messages = [];
  final DatabaseHelper _dbHelper = DatabaseHelper();
  late Future<List<moollama_agent.Message>> _messagesFuture;
  List<Agent> _agents = [];
  ...
  Future<List<moollama_agent.Message>> _loadMessages() async {
    ...
    setState(() {
      ...
      _messages.addAll(
        maps.map((map) {
          ...
          if (isUser) {
            return moollama_agent.Message(finalText: map['text'], isUser: true);
          } else {
  ...
  void _sendMessage() async {
    if (_textController.text.isNotEmpty &&
      ...
      setState(() {
        _messages.add(moollama_agent.Message(finalText: userMessageText, isUser: true));
        _messages.add(moollama_agent.Message(finalText: '', isUser: false, isLoading: true));
      ...
      if (_agent != null) {
        try {
          ...
          final List<moollama_agent.Message> history = _messages
          ...
          await for (final response in _agent!.generate(
            ...
            if (response.status == moollama_agent.AgentResponseStatus.success) {
              ...
              setState(() {
                _messages.last = moollama_agent.Message(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: _isLoading
                          ...
                          : FutureBuilder<List<moollama_agent.Message>>(
  ...
  Widget _buildMessageBubble(moollama_agent.Message message) {
